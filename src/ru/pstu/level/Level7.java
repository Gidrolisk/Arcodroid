...
public class Level7 extends AbstractLevel {
    ...
    public void loadGameObjects(GameView view, Resources resources) {
        ...
        addBlocks(bmp, 2);
        // line 3
        addBlocks(bmp, 3, 1, 2, 3, 4, 6, 7, 8);
        // line 4
        addBlocks(bmp, 4, 1, 4, 6, 8);
        // line 5
        addBlocks(bmp, 5, 1, 6, 8);
        // line 6
        addBlocks(bmp, 6, 1, 3, 4, 6, 8);
        // line 7
        addBlocks(bmp, 7, 1, 4, 6, 8);
        // line 8
        addBlocks(bmp, 8, 1, 2, 3, 4, 6, 7, 8);
        // line 9
        addBlocks(bmp, 9);
        // line 10
